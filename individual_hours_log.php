        ...
        <form method="post" name="form_new" action="<?php echo $editFormAction; ?>">
          <tr bordercolor="#CCCCCC">
            <td height="40" valign="bottom"><strong>New User:</strong><br>
              ...
              <?php //list_contacts_select_user('contact_id', $new_user_id); //This is a dropdown box that needs to be replaced with the type ahead control?>
              
              	<!--This is the code for the type ahead name box-->
