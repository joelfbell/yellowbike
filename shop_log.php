...
<link type="text/css" rel="stylesheet" media="all" href="/js/ta.css">
    ...
    <td>
      <table   border="1" cellpadding="1" cellspacing="0" bordercolor="#CCCCCC">
        <tr bordercolor="#CCCCCC" bgcolor="#99CC33">
          <td width="100" height="35"><strong>Shop User </strong> > <a href="<?php echo $page_edit_contact; ?>?contact_id=new_contact&shop_id=<?php echo $shop_id?>">Create New User</a></td>
...
<input type=hidden id=contact_id name=contact_id>
		  ...
		  <td valign="bottom"><strong>
		    <?php if($totalRows_Recordset1 <> 0){ 
									...
									list_time("{$shop_date} 00:00:00",'0000-00-00 00:00:00','time_in',0, 0, 'none',24);				
									}
									?>
		    </strong></td>
	  ...
	  if($visit_id == $row_Recordset1['shop_visit_id']) {  //Visit ID being edited ?>
        <form method="post" name="FormUpdate_<?php echo $row_Recordset1['shop_visit_id']; ?>" action="<?php echo $editFormAction; ?>">
		  ...
		  <td><?php 
			if ($row_Recordset1['time_out'] <> '0000-00-00 00:00:00'){
				list_time($row_Recordset1['time_in'],$row_Recordset1['time_out'],'time_out',0,1,$row_Recordset1['time_out'],16);
			} ?></td>
	  ...
	  <?php } else { //This section executes if it is not the visit_id selected NOT FOR EDIT ?> 
        <form method="post" name="FormUpdate_<?php echo $row_Recordset1['shop_visit_id']; ?>" action="<?php echo $editFormAction; ?>">
          <tr bordercolor="#CCCCCC">
            <td><a href="<?php echo "{$page_individual_history_log}?contact_id=" . $row_Recordset1['contact_id']; ?>"><?php echo utf8_encode($row_Recordset1['full_name']); ?></a></td>
		  <td><?php echo $row_Recordset1['shop_user_role']; ?></td>
		  <td><?php echo date_to_time($row_Recordset1['time_in']); ?></td>
		  <td><?php echo list_time($row_Recordset1['time_in'],$row_Recordset1['time_out'],'time_out',0,1,'none', 16,$row_Recordset1['et']); ?></td>
