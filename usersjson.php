...
function generate_list2($querySQL,$list_value,$list_text, $form_name, $default_value)
{
	...
	{ 
		echo '{';
		echo '  "value": "' . utf8_encode($row_recordset[$list_value]) . '",';
		echo '  "name": "' . utf8_encode($row_recordset[$list_text]) . '",';
		echo '  "combo": "' . utf8_encode($row_recordset[$list_text]) . '                                                           ~' . $row_recordset[$list_value] . '"';
		echo '}, ';
	} 
