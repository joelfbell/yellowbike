...
$query_Recordset1 = "SELECT * FROM view_ShopUserHours3_Composite_$period ORDER BY NameLastFirst;";
...
<?php include("include_header.html"); ?>
        ...
        <table>
        <tr valign="top">
          <td><span class="yb_heading3red">Hours by User for <?php echo $periodname;?> (non-paid)</span></td>
	  </tr>
	  <tr valign="top">
          ...
          <td>
            <table   border="1" cellpadding="1" cellspacing="0">
              <tr valign="top" bgcolor="#99CC33" class="yb_standardCENTER">
			    ...
			    <td width="150">Volunteer Hours</td>
			    <td width="150">Personal Hours</td>
			    <td width="150">Total Hours</td>
		      </tr>
		    ...
		    <?php } else { // end if EDIT RECORD ?>
              <tr> 
			    ...
			    <td class="yb_standardRightred">&nbsp;<?php echo number_format($row_Recordset1['TotalHoursVol'],$round); ?></td>
			    <td class="yb_standardRight">&nbsp;<?php echo number_format($row_Recordset1['TotalHoursPer'],$round); ?></td>
			    <td class="yb_standardRight">&nbsp;<?php echo number_format($row_Recordset1['TotalHoursAll'],$round); ?></td>
