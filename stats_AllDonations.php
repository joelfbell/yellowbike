...
$query_Recordset1 = "SELECT * FROM ybdb.view_Transactions_OutgoingDonations;";
...
<?php include("include_header.html"); ?>
        ...
        <table>
        <tr valign="top">
          <td><span class="yb_heading3red">All Bike Donations</span> </td>
	  </tr>
        <tr>
          <td>
            <table   border="1" cellpadding="1" cellspacing="0">
              ...
              <tr valign="top" bgcolor="#99CC33" class="yb_standardCENTER">
                <td width="50" height="35">Year</td>
                <td width="50">Month</td>
                <td width="100">Date</td>
                <td width="200">Donation Type</td>
                <td width="100">Number of Bikes</td>
                <td width="400">Description</td>
			    <td width="150">Logged By</td>			    
		      </tr>
		    ...
		    <?php } else { // end if EDIT RECORD ?>
              <tr>
                ...
                <td><?php echo number_format($row_Recordset1['NumberOfBikes'],0); ?></td>
                <td><?php echo $row_Recordset1['Description']; ?></td>
                <td><?php echo $row_Recordset1['LoggedBy']; ?></td>
		      </tr>
              <?php
		  } // end if EDIT RECORD 
