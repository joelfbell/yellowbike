...
shops.shop_type as ShopType, transaction_type, ROUND(sum(t.amount),2) as Total, count(t.transaction_id) as CountOfTrans
...
WHERE ttype.accounting_group = 'Sales' OR ttype.accounting_group = 'Incoming Donations'
GROUP BY t.shop_id, date_format(t.date,'%m/%d/%Y'), transaction_type
ORDER BY date(t.date) DESC, t.shop_id, transaction_type DESC;";
          ...
          <td>
            <table   border="1" cellpadding="1" cellspacing="0">
              ...
              <tr valign="top" bgcolor="#99CC33" class="yb_standardCENTER">
			    ...
			    <td width="300">Transaction Type</td>
		    ...
		    <?php } else { // end if EDIT RECORD ?>
              <tr>
			    ...
			    <td valign="middle"><?php echo $row_Recordset1['transaction_type']; ?></td>
