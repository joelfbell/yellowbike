...
shops.shop_type as ShopType, payment_type, ROUND(sum(t.amount),2) as Total, count(t.transaction_id) as CountOfTrans
...
GROUP BY t.shop_id, date_format(t.date,'%m/%d/%Y'), payment_type
ORDER BY date(t.date) DESC, t.shop_id, payment_type DESC;";
          ...
          <td>
		    ...
		    <?php } else { // end if EDIT RECORD ?>
              <tr>
			    ...
			    <td valign="middle"><?php echo $row_Recordset1['payment_type']; ?></td>
